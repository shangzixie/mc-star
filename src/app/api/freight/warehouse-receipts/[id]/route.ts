  ...
  try {
    ...
    const [receipt] = await db
      .select({
        ...
        seaCarrierRoute: warehouseReceipts.seaCarrierRoute,
        seaVesselVoyage: warehouseReceipts.seaVesselVoyage,
    ...
    const updated = await db.transaction(async (tx) => {
      const [result] = await tx
        ...
        .set({
          ...
          seaCarrierRoute: body.seaCarrierRoute,
          seaVesselVoyage: body.seaVesselVoyage,
